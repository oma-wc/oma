...
function endsWith$1(string, substring) {
...
function allNumberGroupsAreExactlyPresent(metadata, number, normalizedCandidate, formattedNumberGroups) {
  ...
  return candidateNumberGroupIndex >= 0 && endsWith$1(candidateGroups[candidateNumberGroupIndex], formattedNumberGroups[0]);
}
